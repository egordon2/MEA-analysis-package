...
#'
#' @description Function reads in electrode burst list data and creates new columns with the mean, SD, and SEM number of bursts recorded for each well within a given time interval of a recording
#'
#' @param name data, time_lower_bound, time_upper_bound, recording_identifier
#'
#' @return electrode burst list table with three additional columns (mean, SD and SEM number of bursts recorded for each well within a given time interval of a recording)
#' @export
#'
#' @examples
