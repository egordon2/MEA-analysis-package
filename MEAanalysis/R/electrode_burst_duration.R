...
######  function creates new columns with the mean, SD, and SEM burst duration recorded by specific electrodes within a given time interval and specific recording   ###### 
